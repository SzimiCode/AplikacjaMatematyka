  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        ...
        children: [
          ListTile(title: const Text('Szymon Molitorys')),
          const Divider(),
          ...
          ListTile(
            ...
            onTap: () {
              showLicensePage(
                ...
                applicationLegalese:
                    '© 2026 Szymon Molitorys, Jakub Stępień, Mateusz Roździński\n'
                    ...
                    'Gemini API plan darmowy dla własnego użytku'
                    'Ikona ognia stworzona przez Bahu Icons',
              );
            },
          ),
